...
import "../style.css";
import BottomNavbar from "../components/Navbar"; // React.memo bilan qoplangan bo'lishi kerak

// Sahifalarni lazy load qilish
const BattlePage = lazy(() => import("./BattlePage"));
...
const MainPage = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => setShowBonusButton(true), 1000);
  }, []);
  ...
  // useCallback orqali funksiyani qayta render bo'lishdan saqlaymiz
  const changePage = useCallback((page) => setActivePage(page), []);
